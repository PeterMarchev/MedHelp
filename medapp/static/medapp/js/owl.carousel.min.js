			...
			},
			{
				...
				run: function() {
					...
					for (a = 0, b = Math.abs(e / 2); b > a; a++)
						e > 0
							? (this.$stage.children().eq(d.length + c.length - 1).remove(),
								c.pop(),
		...
		(b.Defaults = {
			...
			(b.prototype.initialize = function() {
				...
				d.dotsData ||
					...
					this._controls.$previous.addClass(d.navClass[0]).html(d.navText[0]).hide().prependTo(b).on(
						'click',
						a.proxy(function() {
							this.prev(d.navSpeed);
						}, this)
					),
					this._controls.$next.addClass(d.navClass[1]).html(d.navText[1]).hide().appendTo(b).on(
						'click',
						a.proxy(function() {
